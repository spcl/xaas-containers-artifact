...
TESTCASE_DIR="${ARTIFACT_LOCATION}/benchmarks-source/gromacs/ault23/gromacs-benchmarks/TestcaseA_benchmarks-portable/gromacs_testcase0_ault23_testcaseA/steps_${STEPS}"
