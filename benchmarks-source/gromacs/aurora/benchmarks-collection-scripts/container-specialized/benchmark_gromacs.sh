...
TESTCASE_DIR="$HOME/xaas-containers-artifact/hpc-benchmarks/gromacs/aurora/gromacs-benchmarks/TestcaseB_benchmarks/gromacs_specialized_testcaseB"
...
for i in $(seq 1 $TOTAL_RUNS); do
  ...
  apptainer exec $HOME/xaas-containers/images/apptainer/gromacs-mpi-ipc.sing gmx mdrun -s $TPR_FILE -ntomp 104 -ntmpi 1 -nsteps 100 > "$RUN_DIR/mdrun_output.log" 2>&1
