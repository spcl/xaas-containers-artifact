...
ARCH_TYPE="CUDA_AVX2_256"
TESTCASE_DIR="${ARTIFACT_LOCATION}/benchmarks-ir/gromacs-gpu/ault25/gromacs-benchmarks/TestcaseA_benchmarks/gromacs_${ARCH_TYPE}_testcaseA/steps_${STEPS}"
TPR_FILE="${ARTIFACT_LOCATION}/data/gromacs/GROMACS_TestCaseA/ion_channel.tpr"
CONTAINER_IMAGE="${DOCKER_REPOSITORY}:gromacs-gpu-deploy-${ARCH_TYPE}"
