...
ARCH_TYPE="CUDA_AVX_512"
TESTCASE_DIR="${ARTIFACT_LOCATION}/benchmarks-ir/gromacs-gpu/ault23/gromacs-benchmarks/TestcaseA_benchmarks/gromacs_${ARCH_TYPE}_testcaseA/steps_${STEPS}"
