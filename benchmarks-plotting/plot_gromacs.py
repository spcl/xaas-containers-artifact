...
def plot_grouped_bar(df, metric_name):
    ...
    plt.savefig("gromacs_portability.pdf", bbox_inches="tight")
...
def main():
    parser = argparse.ArgumentParser(
        description="Plot GROMACS benchmark data with Seaborn."
    )
    parser.add_argument(
        "input_directory", type=str, help="Root of the hpc-benchmarks directory"
    )
