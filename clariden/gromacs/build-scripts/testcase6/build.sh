...
cmake .. -DGMX_SIMD=ARM_NEON_ASIMD -DGMX_BUILD_OWN_FFTW=ON -DGMX_GPU=CUDA -DGMX_MPI=ON -DGMX_OPENMP=ON -DCMAKE_INSTALL_PREFIX=$HOME/testcase6/gromacs-2025.0
