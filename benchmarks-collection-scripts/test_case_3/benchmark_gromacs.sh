...
source /opt/intel/oneapi/mkl/latest/env/vars.sh && \
    ...
    mpiexec -n 4 gmx_mpi mdrun -s \"/host_home/GROMACS_TestCaseA/ion_channel.tpr\" -ntomp 16  -nsteps 100 > \"/host_home/benchmarks_phase1/TestcaseA_benchmarks/gromacs_testcase3_testcaseA/run${i}/mdrun_output.log\" 2>&1 && \
